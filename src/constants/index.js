...
export const HERO_CONTENT = {
  ...
  introduction:
    "I’m Prashant Dobariya, a creative frontend developer, crafting immersive and intuitive web experiences.",
  description:
...
export const CONTACT_CONTENT = {
  ...
  email: "prashantdobariya276@gmail.com",
  socialLinks: [
    {
      platform: "Twitter",
  ...
  footerText: `© ${new Date().getFullYear()} Prashant Dobariya. All rights reserved.`,
};
